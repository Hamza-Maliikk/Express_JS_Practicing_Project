...
const API = `https://expressjspracticingproject-production.up.railway.app/api/homepage`;
console.log(API);
...
export default function HomePage() {
  ...
  return (
    <div style={{
      ...
      {hero && (
        <section className="section-pad" style={{
          ...
          <div className="fu d5 stats-grid" style={{
            ...
            gap: 14, marginTop: 72, position: "relative", zIndex: 1,
          }}>
            {[
              ...
              <div className="stat-box" key={s.label}>
                ...
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.28)", letterSpacing: "0.05em" }}>
                  {s.label}
                </div>
              </div>
            ))}
      ...
      {/* ── SELECTED WORKS ───────────────────────────────────── */}
      {last4Work.length > 0 && (
        <section className="section-pad" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 48px" }}>
